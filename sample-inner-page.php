...
<head>
  ...
  <title>Member Resources | Mashirikiano SACCO</title>
  ...
  <link rel="canonical" href="https://mashirikianosacco.co.ke/sample-inner-page.php">
  ...
  <main id="main">
        ...
        <div class="container position-relative">
          <div class="row d-flex justify-content-center">
            <div class="col-lg-6 text-center">
              ...
              <p>Access SACCO updates, financial education content, and practical member guides to help you save better, borrow responsibly, and grow your investments.</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <section class="sample-page">
      <div class="container" data-aos="fade-up">
        <p>
          This page can be used for member notices, downloadable forms, policies, and savings or loan education materials.
        </p>
      </div>
    </section>
